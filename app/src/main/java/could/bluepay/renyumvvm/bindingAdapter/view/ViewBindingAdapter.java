package could.bluepay.renyumvvm.bindingAdapter.view;
...
import could.bluepay.renyumvvm.bindingAdapter.command.ResponseCommand;
...
public final class ViewBindingAdapter {
    ...
    @BindingAdapter({"android:onFocusChangeCommand"})
    ...
    @BindingAdapter({"android:onTouchCommand"})
