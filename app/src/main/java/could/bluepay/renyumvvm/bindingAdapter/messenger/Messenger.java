...
public class Messenger {
     ...
     */
    public void register(Object recipient, Runnable action) {
        try {
     ...
     * @param action   do something on message received
     */
    public void register(Object recipient, boolean receiveDerivedMessagesToo, Runnable action) {
     ...
     * @param action  do something on message received
     */
    public void register(Object recipient, Object token, Runnable action) {
     ...
     * @param action  do something on message received
     */
    public void register(Object recipient, Object token, boolean receiveDerivedMessagesToo, Runnable action) {
    ...
    /**
     * send the message type of T, all receiver can receive the message
     * @param message  any object can to be a message 传递的消息Bean类
     * @param token send with a unique token,when a receiver has register with same token,it will receive this message 唯一标示
     * @param <T> message data type
     */
