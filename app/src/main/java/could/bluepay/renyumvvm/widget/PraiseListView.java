...
public class PraiseListView extends android.support.v7.widget.AppCompatTextView{
    ...
    public void notifyDataSetChanged(){
        ...
        //// TODO: 2017/11/28
//        setMovementMethod(new DynamicMovementMethod(itemSelectorColor));
    }
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(MixApp.getContext(), R.drawable.icon_praise, DynamicDrawableSpan.ALIGN_BASELINE),
