...
public class DynamicMovementMethod extends BaseMovementMethod {
    public final String TAG = DynamicMovementMethod.class.getSimpleName();
    private final static int DEFAULT_COLOR_ID = R.color.transparent;
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.color_cccccc;
    /**整个textView的背景色*/
    ...
    public DynamicMovementMethod(){
        this.textViewBgColor = MixApp.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = MixApp.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
     ...
     */
    public DynamicMovementMethod(int clickableSpanBgClor){
     ...
     */
    public DynamicMovementMethod(int clickableSpanBgClor, int textViewBgColor){
