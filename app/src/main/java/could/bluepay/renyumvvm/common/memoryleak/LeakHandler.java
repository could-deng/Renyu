package could.bluepay.renyumvvm.common.memoryleak;
...
/**
 * 处理android 系统输入法引出的内存泄漏
 */
public class LeakHandler {
    ...
    static class ReferenceCleaner
        ...
        private void clearInputMethodManagerLeak() {
            try {
                ...
                Logger.e("IMMLeaks", "Unexpected reflection exception", unexpected);
            }
        }
