...
import could.bluepay.renyumvvm.common.compress.Luban;
import could.bluepay.renyumvvm.common.compress.OnCompressListener;
...
public class PictureBaseActivity extends FragmentActivity {
    ...
    protected void compressImage(final List<LocalMedia> result) {
        showCompressDialog();
        if (config.synOrAsy) {//同步调用，尽量避免在主线程进行，以防造成线程阻塞
