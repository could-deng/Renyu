...
import could.bluepay.renyumvvm.common.anim.OptAnimationLoader;
...
import could.bluepay.renyumvvm.widget.pictureSelector.PreviewViewPager;
import could.bluepay.renyumvvm.widget.pictureSelector.longimage.ImageSource;
import could.bluepay.renyumvvm.widget.pictureSelector.longimage.ImageViewState;
import could.bluepay.renyumvvm.widget.pictureSelector.longimage.SubsamplingScaleImageView;
import could.bluepay.renyumvvm.widget.pictureSelector.photoview.OnViewTapListener;
import could.bluepay.renyumvvm.widget.pictureSelector.photoview.PhotoView;

/**
 * 图片以ViewPager浏览Activity
 */
public class PicturePreviewActivity extends PictureBaseActivity implements View.OnClickListener, Animation.AnimationListener {
    ...
    private Animation animation;//右上方的TextView和右下方TextView的动画
...
//        updateSelector(refresh);
    ...
    /**
     * 是否更新图片列表(PictureSelectorActivity)选中效果
     *
     * @param isRefresh
     */
    ...
    public void onResult(List<LocalMedia> images) {
        ...
        if (!config.isCompress) {
            Logger.i(Logger.DEBUG_TAG,"**** not compress finish");
            onBackPressed();
        } else {
            Logger.i(Logger.DEBUG_TAG,"**** loading compress");
            showPleaseDialog();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case UCropMulti.REQUEST_MULTI_CROP://裁剪完成
