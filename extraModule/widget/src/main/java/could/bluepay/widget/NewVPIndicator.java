...
public class NewVPIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        //todo 资源
//        R.color.indicator_textColor_check
        mIndicatorColor = getResources().getColor(android.R.color.white);

        mIndicatorWidth = dp2px(getContext().getResources(),50);
        mIndicatorHeight = dp2px(context.getResources(),1);
//        R.color.indicator_textColor_def
        mTextColor = getResources().getColor(android.R.color.white);
        mTextSize = 18;
...
//    }
    private float dp2px(Resources resouces, int dp){
